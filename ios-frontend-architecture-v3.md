# iOS Frontend Architecture (v3.0)
...
The `anchored` status is displayed as a subtle chain-link icon (🔗) next to the message timestamp, indicating blockchain-verified integrity. This is a differentiating UX feature — users can see which messages have been cryptographically anchored on-chain.
