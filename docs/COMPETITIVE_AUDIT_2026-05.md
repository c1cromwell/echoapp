...
**See also:** [`SIGNAL_ECHO_PARITY.md`](SIGNAL_ECHO_PARITY.md) — deep review of vendored **libsignal / Signal-Server / Signal-iOS** vs Echo; post-launch Waves S1–S5 (sync/backup, sealed-sender, Sender Keys, calls, UX).
