# Echo - Product Requirements Document (v2.4)
...
| Treasury | 25% | 250M | PacaSwap liquidity, DAG staking, Digital Evidence subscriptions, operations, Phase 5–6 |
| Founders (5) | 15% | 150M | 4-year vesting, 1-year cliff, on-chain TokenLock (see Tokenomics doc) |
...
**Founder Allocation (15% = 150M ECHO, visionary-led split):**

| Founder | Role | Share | ECHO | % Supply |
|---------|------|-------|------|----------|
| Founder 1 | CEO / Visionary / Product | 40% | 60M | 6.0% |
| Founder 2 | CTO / Lead iOS Engineer | 25% | 37.5M | 3.75% |
| Founder 3 | Scala / Blockchain Lead | 15% | 22.5M | 2.25% |
| Founder 4 | Head of Growth / Community | 10% | 15M | 1.5% |
| Founder 5 | Head of Design / UX | 10% | 15M | 1.5% |
...
**Ownership:** All ECHO token holders are owners. Token-weighted voting on all governance proposals. Trust tier provides a secondary weight — Tier 5 (Trusted) votes carry more weight than Tier 1 (Unverified) to prevent Sybil attacks on governance.
...
- Governance DAO (stake-weighted voting via StakeDelegation on protocol upgrades, metagraph schema changes, slashing thresholds)
