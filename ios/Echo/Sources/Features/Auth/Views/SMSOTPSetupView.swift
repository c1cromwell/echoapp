    ...
    private var phoneEntryBody: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 8) {
                ...
                Text("We save a secure version of your number to help you recover your account. After verifying, you can let friends find you by phone number.")
                    .font(.system(size: 13))
    ...
    private var doneBody: some View {
        VStack(spacing: 20) {
            ...
            Text("Phone backup added")
                .font(.system(size: 20, weight: .bold))
                .foregroundColor(.echoPrimaryText)
            Text("Your number is now saved securely for account recovery and finding contacts. You can change these settings anytime in Privacy.")
                .font(.system(size: 13))
                .foregroundColor(.echoSecondaryText)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 32)
