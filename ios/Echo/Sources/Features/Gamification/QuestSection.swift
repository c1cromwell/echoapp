            ...
            if !viewModel.advancedQuests.isEmpty {
                DisclosureGroup(isExpanded: $showAdvanced) {
                    ...
                    Text("Advanced Quests")
                        .typographyStyle(.label, color: .echoSecondaryText)
                }
            }
        ...
        HStack(spacing: Spacing.sm.rawValue) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text("Next up: \(quest.title)")
                    .typographyStyle(.label, color: .echoPrimaryText)
        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack(alignment: .top) {
                ...
                Text("+\(formatEcho(quest.rewardAmount))")
                    .typographyStyle(.label, color: .echoSignal)
            }
                ...
                if quest.rewardClaimed {
                    ...
                    Button(action: onClaim) {
                        if isClaiming {
                            ...
                            Text("Claim")
                                .typographyStyle(.label, color: .white)
